...
function fixture(role = "admin") {
  const users = [{ id: "learner1", username: "learner", full_name: "Test Learner", role: "student", active: true, pin: "sha256:03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4" }];
  const records = [];
  const sessions = [];
