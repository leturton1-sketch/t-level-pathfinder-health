    ...
    <div className="space-y-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-xs font-bold text-clinical-teal">{coveredSK.size}/{skEntries.length} · {skPct}%</span>
        </div>
          ...
          {skEntries.map(([code, desc]) => {
            ...
            return (
              <div key={code} className="flex items-center gap-2 text-xs">
                ...
                <span className="font-mono font-semibold text-clinical-teal w-10 shrink-0">{code}</span>
