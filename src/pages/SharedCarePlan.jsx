      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-4 pt-4 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            {SBAR_PATIENTS.map((p) => (
              <button
                ...
                className={`rounded-lg px-3 py-1.5 text-xs font-heading font-semibold border transition-all ${caseId === p.id ? "bg-clinical-teal text-white border-clinical-teal shadow-sm" : "bg-card text-muted-foreground border-border hover:border-clinical-teal/40"}`}
              >
                {p.name}
              </button>
            ))}
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`flex items-center gap-1 rounded-lg px-2 py-1 text-[10px] font-heading font-semibold border ${voiceOn ? "bg-clinical-teal text-white border-clinical-teal" : "bg-card text-muted-foreground border-border"}`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          {TEXT_SECTIONS.map((sec) => (
            <div key={sec.key} className="rounded-xl border border-border bg-card p-3 shadow-sm">
              <div className="flex items-center gap-1.5 mb-2">
              ...
              <textarea
                ...
                rows={6}
                className="w-full rounded-lg border border-border bg-muted/40 p-2.5 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-clinical-teal/50 focus:bg-card resize-y scrollbar-thin"
              />
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={resetAll}
            className="flex items-center gap-1.5 rounded-lg border border-border bg-card px-3 py-2 text-xs font-heading font-semibold text-muted-foreground hover:bg-muted/40"
          >
          ...
          <button
            ...
            disabled={saving}
            className="flex items-center gap-1.5 rounded-lg border border-border bg-card px-3 py-2 text-xs font-heading font-semibold text-muted-foreground hover:bg-muted/40 disabled:opacity-50"
          >
