...
function ScenarioLab() {
  ...
  return <div className="grid gap-4 xl:grid-cols-[300px_minmax(0,1fr)_360px]">
    ...
    <section className={`${panel} p-6`}>
      ...
      <button onClick={()=>setFeedback(calculateScenarioFeedback(patient,observations,choices))} className="mt-6 w-full rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 px-5 py-3 text-sm font-black text-white shadow-lg"><Sparkles className="mr-2 inline h-4 w-4"/>Submit session for formative feedback</button>
    </section>
    <aside className={`${panel} p-6`}>
