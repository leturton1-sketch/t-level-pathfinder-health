      ...
      <div className="relative mx-auto max-w-[1560px] px-4 py-4 sm:px-6 lg:px-8">
        ...
        <section className="grid gap-4 xl:grid-cols-[180px_minmax(0,1fr)_300px]">
          <aside className="grid grid-cols-2 gap-3 sm:grid-cols-4 xl:block xl:space-y-2" aria-label="Quick launch">
            ...
            <QuickLaunch icon={ClipboardHeart} label="Health Hub" detail="Clinic checks and records" tone="bg-gradient-to-br from-mint-300 to-emerald-700" onClick={() => navigate("/health-hub")} />
