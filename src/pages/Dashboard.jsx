...
const MODULES = [
  ...
  { title: "Scenario Templates", desc: "Build reusable patient scenario templates and clone them for new simulation exercises.", icon: Stethoscope, color: "coral", to: "/scenario-templates", adminOnly: true },
