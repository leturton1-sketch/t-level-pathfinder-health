...
const ANATOMICAL_ATLAS = {
  ...
  arterial_tree: { parts: [
    { shape: { type: "tube", radius: 0.007, points: [[0,1.42,-0.01],[0.06,1.41,0],[0.10,1.36,0],[0.14,1.30,0],[0.15,1.22,0]] } },
    { shape: { type: "tube", radius: 0.007, points: [[0,1.42,-0.01],[-0.06,1.41,0],[-0.10,1.36,0],[-0.14,1.30,0],[-0.15,1.22,0]] } },
    { shape: { type: "tube", radius: 0.008, points: [[0.03,0.94,-0.04],[0.05,0.82,0],[0.055,0.65,0],[0.05,0.45,0]] } },
    { shape: { type: "tube", radius: 0.008, points: [[0.03,0.94,-0.04],[-0.05,0.82,0],[-0.055,0.65,0],[-0.05,0.45,0]] } },
    { shape: { type: "tube", radius: 0.006, points: [[-0.01,1.30,0.04],[0.04,1.30,0.03],[0.08,1.31,0.02]] } },
    { shape: { type: "tube", radius: 0.006, points: [[-0.01,1.30,0.04],[-0.04,1.30,0.03],[-0.08,1.31,0.02]] } },
    { shape: { type: "tube", radius: 0.0045, points: [[0,1.42,-0.01],[0,1.53,0],[0,1.59,0]] } },
  ] },
  venous_tree: { parts: [
    { shape: { type: "tube", radius: 0.0065, points: [[0.15,1.22,0.025],[0.12,1.30,0.02],[0.08,1.38,-0.01],[0.028,1.4,-0.04]] } },
    { shape: { type: "tube", radius: 0.0065, points: [[-0.15,1.22,0.025],[-0.12,1.30,0.02],[-0.08,1.38,-0.01],[0.028,1.4,-0.04]] } },
    { shape: { type: "tube", radius: 0.0075, points: [[0.05,0.45,0.02],[0.055,0.65,0.01],[0.05,0.82,-0.01],[0.02,0.94,-0.04]] } },
    { shape: { type: "tube", radius: 0.0075, points: [[-0.05,0.45,0.02],[-0.055,0.65,0.01],[-0.05,0.82,-0.01],[0.02,0.94,-0.04]] } },
    { shape: { type: "tube", radius: 0.0055, points: [[0.08,1.31,0.02],[0.04,1.30,0.03],[-0.01,1.30,0.04]] } },
    { shape: { type: "tube", radius: 0.0055, points: [[-0.08,1.31,0.02],[-0.04,1.30,0.03],[-0.01,1.30,0.04]] } },
  ] },
