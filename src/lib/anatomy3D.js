...
const ANATOMICAL_ATLAS = {
  ...
  arterial_tree: { parts: [
    { shape: { type: "tube", radius: 0.007, points: [[0,1.42,-0.01],[0.08,1.43,0],[0.14,1.38,0],[0.18,1.28,0],[0.20,1.14,0]] } },
    { shape: { type: "tube", radius: 0.007, points: [[0,1.42,-0.01],[-0.08,1.43,0],[-0.14,1.38,0],[-0.18,1.28,0],[-0.20,1.14,0]] } },
    { shape: { type: "tube", radius: 0.008, points: [[0.03,0.94,-0.04],[0.06,0.82,0],[0.065,0.55,0],[0.06,0.32,0]] } },
    { shape: { type: "tube", radius: 0.008, points: [[0.03,0.94,-0.04],[-0.06,0.82,0],[-0.065,0.55,0],[-0.06,0.32,0]] } },
    { shape: { type: "tube", radius: 0.0045, points: [[0,1.42,-0.01],[0,1.53,0],[0,1.59,0]] } },
  ] },
  venous_tree: { parts: [
    { shape: { type: "tube", radius: 0.0065, points: [[0.20,1.14,0.025],[0.16,1.30,0.02],[0.10,1.40,0.01],[0.04,1.42,-0.02],[0.028,1.4,-0.04]] } },
    { shape: { type: "tube", radius: 0.0065, points: [[-0.20,1.14,0.025],[-0.16,1.30,0.02],[-0.10,1.40,0.01],[-0.04,1.42,-0.02],[0.028,1.4,-0.04]] } },
    { shape: { type: "tube", radius: 0.0075, points: [[0.06,0.32,0.02],[0.065,0.55,0.01],[0.05,0.82,-0.01],[0.02,0.94,-0.04]] } },
    { shape: { type: "tube", radius: 0.0075, points: [[-0.06,0.32,0.02],[-0.065,0.55,0.01],[-0.05,0.82,-0.01],[0.02,0.94,-0.04]] } },
  ] },
