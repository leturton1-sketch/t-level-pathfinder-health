...
export const VOICE_PROFILES = [
  {
    ...
    cloudVoice: "honey",
    browserVoicePatterns: ["aria", "sonia", "libby", "hazel", "susan", "female", "natural", "neural"],
    backupName: "Natural female system voice",
    rate: 0.98,
    pitch: 1.12,
    stability: 0.64,
    gender: "female",
  },
  {
    ...
    cloudVoice: "storm",
    browserVoicePatterns: ["ryan", "oliver", "george", "daniel", "thomas", "male", "natural", "neural"],
    backupName: "Natural male system voice",
    rate: 0.96,
    pitch: 0.74,
    stability: 0.64,
    gender: "male",
