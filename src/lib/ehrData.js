...
export const EHR_RECORDS = {
  ...
  ladygaga: {
    ...
    nursingNotes: [
      ...
      { type: "handover", timestamp: "14/08/2026 20:00", author: "RN Foster, Night shift", content: "Lady Gaga B2 — fibromyalgia flare Day 0. Pain 9/10 despite pregabalin + paracetamol. Hyperalgesia — flinches at light touch. All touch announced beforehand. Lower limbs: bilateral eczematous patches with breakdown — foam dressings applied, non-adherent. Epaderm applied TDS in hair direction. Nitrile gloves confirmed. Slept 2hr, restless. Anxious but grateful for person-centred approach." },
      { type: "observation", timestamp: "15/08/2026 06:00", author: "RN Green", vitals: { rr: 15, spo2: 99, sbp: 122, hr: 84, temp: 36.8, avpu: "A" }, news2: 0 },
      { type: "handover", timestamp: "15/08/2026 14:00", author: "RN Green, handover to PM", content: "Lady Gaga B2 — Day 1. NEWS2 0, stable. Pain 7/10 after pregabalin BD — improved. Lower limb dressings changed — skin healing well, no signs of infection. Emollient regimen maintained. Dynamic consent throughout — patient 'thank you for asking before you touch, it means everything'. Psych referral made re: PTSD/mental health support. Continue trauma-informed care." },
    ],
    labResults: {
      haematology: [
